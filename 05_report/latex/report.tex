...
\begin{center}
\small
\begin{tblr}{colspec={Q[l,m,wd=0.9cm] Q[l,m,wd=5.6cm] Q[l,m,wd=4.0cm] Q[r,m,wd=2.4cm]}, rowsep=2pt, colsep=4pt}
\toprule
...
\midrule
\SetCell[c=3]{r}\textbf{Cumulative IRO absorption (of Aqualia's 83)} & & & \textbf{61 (73\%)} \\
\bottomrule
\end{tblr}
\end{center}
